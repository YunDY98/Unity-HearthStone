...
public class EntityManager : MonoBehaviour
{
    ...
    IEnumerator AICo()
    {
       CardManager.Inst.TryPutCard(false);
		...
		// attackableol true인 모든 othenEntites를 가져와 순서를 섞는다
	...
	public void EntityMouseUp() 
	{
		...
		// selectEntity, targetPickEntity 둘다 존재하면 공격한다. 바로 nu11, nul1로 만든다.
	...
	{
		// attacker가 defender의 위치로 이동하다 원래 위치로 온다, 이때 order가 높다
